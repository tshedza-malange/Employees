...
app.post("/addEmployee", (req, res) => {
    const { employeeNo, firstName, lastName, salutation, profileColor} = req.body;

    const newEmployee = new userModel({ employeeNo, firstName, lastName, salutation, profileColor});
